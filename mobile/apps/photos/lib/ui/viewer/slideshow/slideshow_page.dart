...
class SlideshowPage extends StatefulWidget {
  SlideshowPage({required this.files, required this.albumName, super.key}) {
    if (files.isEmpty) {
...
class _SlideshowPageState extends State<SlideshowPage>
  ...
  void initState() {
    ...
    _setSlideshowWakeLock(_isForeground && _isPlaying);
  ...
  void didChangeAppLifecycleState(AppLifecycleState state) {
    ...
    if (_isForeground) {
      _setSlideshowWakeLock(_isPlaying);
      _syncSystemUi();
  ...
  Widget _buildSlideSlot({
    ...
    return IgnorePointer(
      child: FadeTransition(
        key: ValueKey("slideshow-slot-$slotIndex-opacity"),
        opacity: opacity,
        child: SizedBox.expand(
          key: ValueKey("slideshow-slot-$slotIndex-$index"),
          child: FileWidget(
            _files[index],
            // Keep simultaneous Hero tags unique even if a source unexpectedly
            // contains the same file more than once.
            tagPrefix: "slideshow_${slotIndex}_",
